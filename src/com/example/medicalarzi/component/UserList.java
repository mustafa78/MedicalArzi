...
public class UserList extends CustomComponent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1784319018129141931L;
	 ...
	 */
	public UserList(Component compositionRoot) {
	...
	private void initSearch() {
		...
		searchField.addTextChangeListener(new TextChangeListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2918633454909992920L;
	...
	private class ContactFilter implements Filter {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 6797099556727451416L;
	...
	private void initAddRemoveButtons() {
		addNewContactButton.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 6544613029010413643L;
		...
		removeContactButton.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2920670537221357947L;
	...
	private void initContactList() {
		...
		contactList.addValueChangeListener(new Property.ValueChangeListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 7832289418240024338L;

...
public class Reviewer implements Serializable {
	...
	private Lookup rvwrTitle; // title in Daawat

	@Size(min = 1, max = 30)
	@NotEmpty(message = "Please enter your first name.")
	private String firstName;

	private Lookup rvwrMiddleNmTitle; // title in Daawat
	...
	public void setSpeciality(Speciality medicalSpeciality) {
	...
	public Lookup getRvwrTitle() {
		return rvwrTitle;
	}

	public void setRvwrTitle(Lookup rvwrTitle) {
		this.rvwrTitle = rvwrTitle;
	}

	public Lookup getRvwrMiddleNmTitle() {
		return rvwrMiddleNmTitle;
	}

	public void setRvwrMiddleNmTitle(Lookup rvwrMiddleNmTitle) {
		this.rvwrMiddleNmTitle = rvwrMiddleNmTitle;
	}
